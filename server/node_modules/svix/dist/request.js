...
const ObjectSerializer_1 = require("./openapi/models/ObjectSerializer");
exports.LIB_VERSION = "1.57.0";
...
class SvixRequest {
    ...
    setBody(value, type) {
        this.body = JSON.stringify(ObjectSerializer_1.ObjectSerializer.serialize(value, type, ""));
    }
    send(ctx, responseType) {
        return __awaiter(this, void 0, void 0, function* () {
            const responseBody = yield this.sendInner(ctx);
            return ObjectSerializer_1.ObjectSerializer.deserialize(JSON.parse(responseBody), responseType, "");
        });
    }
    ...
    sendInner(ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (response.status < 300) {
                ...
                throw new util_1.ApiException(response.status, body, response.headers);
            }
