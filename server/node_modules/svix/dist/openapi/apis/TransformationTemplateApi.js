    ...
    v1TransformationTemplateCreate(connectorIn, idempotencyKey, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (connectorIn === null || connectorIn === undefined) {
                throw new baseapi_1.RequiredError("TransformationTemplateApi", "v1TransformationTemplateCreate", "connectorIn");
            }
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(connectorIn, "ConnectorIn", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["HTTPBearer"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
