...
class StreamApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    v1StreamEventsCreate(streamId, createStreamIn, idempotencyKey, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (streamId === null || streamId === undefined) {
                throw new baseapi_1.RequiredError("StreamApi", "v1StreamEventsCreate", "streamId");
            }
            if (createStreamIn === null || createStreamIn === undefined) {
                throw new baseapi_1.RequiredError("StreamApi", "v1StreamEventsCreate", "createStreamIn");
            }
    ...
    v1StreamStreamCreate(streamIn, idempotencyKey, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (streamIn === null || streamIn === undefined) {
                throw new baseapi_1.RequiredError("StreamApi", "v1StreamStreamCreate", "streamIn");
            }
    ...
    v1StreamStreamDelete(streamId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (streamId === null || streamId === undefined) {
                throw new baseapi_1.RequiredError("StreamApi", "v1StreamStreamDelete", "streamId");
            }
    ...
    v1StreamStreamGet(streamId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (streamId === null || streamId === undefined) {
                throw new baseapi_1.RequiredError("StreamApi", "v1StreamStreamGet", "streamId");
            }
            const localVarPath = '/api/v1/stream/{stream_id}'
                .replace('{' + 'stream_id' + '}', encodeURIComponent(String(streamId)));
            const requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
    ...
    v1StreamStreamPatch(streamId, streamPatch, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (streamId === null || streamId === undefined) {
                throw new baseapi_1.RequiredError("StreamApi", "v1StreamStreamPatch", "streamId");
            }
            if (streamPatch === null || streamPatch === undefined) {
                throw new baseapi_1.RequiredError("StreamApi", "v1StreamStreamPatch", "streamPatch");
            }
            const localVarPath = '/api/v1/stream/{stream_id}'
                .replace('{' + 'stream_id' + '}', encodeURIComponent(String(streamId)));
    ...
    v1StreamStreamUpdate(streamId, streamIn, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (streamId === null || streamId === undefined) {
                throw new baseapi_1.RequiredError("StreamApi", "v1StreamStreamUpdate", "streamId");
            }
            if (streamIn === null || streamIn === undefined) {
                throw new baseapi_1.RequiredError("StreamApi", "v1StreamStreamUpdate", "streamIn");
            }
            const localVarPath = '/api/v1/stream/{stream_id}'
                .replace('{' + 'stream_id' + '}', encodeURIComponent(String(streamId)));
...
class StreamApiResponseProcessor {
    v1StreamEventsCreateWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    v1StreamStreamCreateWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    ...
    v1StreamStreamDeleteWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    ...
    v1StreamStreamGetWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "StreamOut", "");
    ...
    v1StreamStreamListWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
    ...
    v1StreamStreamPatchWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "StreamOut", "");
    ...
    v1StreamStreamUpdateWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "StreamOut", "");
