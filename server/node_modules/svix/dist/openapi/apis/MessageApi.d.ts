...
export declare class MessageApiRequestFactory extends BaseAPIRequestFactory {
    ...
    v1MessagePrecheck(appId: string, messagePrecheckIn: MessagePrecheckIn, idempotencyKey?: string, _options?: Configuration): Promise<RequestContext>;
}
export declare class MessageApiResponseProcessor {
    ...
    v1EventsPublicWithHttpInfo(response: ResponseContext): Promise<HttpInfo<PollingEndpointOut>>;
    ...
    v1MessagePrecheckWithHttpInfo(response: ResponseContext): Promise<HttpInfo<MessagePrecheckOut>>;
}
