    ...
    v1AuthenticationStreamPortalAccess(streamId, streamPortalAccessIn, idempotencyKey, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (streamId === null || streamId === undefined) {
                throw new baseapi_1.RequiredError("AuthenticationApi", "v1AuthenticationStreamPortalAccess", "streamId");
            }
            if (streamPortalAccessIn === null || streamPortalAccessIn === undefined) {
                throw new baseapi_1.RequiredError("AuthenticationApi", "v1AuthenticationStreamPortalAccess", "streamPortalAccessIn");
            }
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(streamPortalAccessIn, "StreamPortalAccessIn", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["HTTPBearer"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
...
class AuthenticationApiResponseProcessor {
    ...
    v1AuthenticationStreamPortalAccessWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "AppPortalAccessOut", "");
