...
export declare class ApplicationApiRequestFactory extends BaseAPIRequestFactory {
    ...
    v1MessageExpungeAllContents(appId: string, idempotencyKey?: string, _options?: Configuration): Promise<RequestContext>;
}
export declare class ApplicationApiResponseProcessor {
    ...
    v1MessageExpungeAllContentsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ExpungAllContentsOut>>;
}
