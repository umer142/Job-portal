    ...
    v1BackgroundTaskGet(taskId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (taskId === null || taskId === undefined) {
                throw new baseapi_1.RequiredError("BackgroundTasksApi", "v1BackgroundTaskGet", "taskId");
            }
...
class BackgroundTasksApiResponseProcessor {
    v1BackgroundTaskGetWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    v1BackgroundTaskListWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
