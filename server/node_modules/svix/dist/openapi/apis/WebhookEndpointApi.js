...
class WebhookEndpointApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    v1OperationalWebhookEndpointCreate(operationalWebhookEndpointIn, idempotencyKey, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (operationalWebhookEndpointIn === null || operationalWebhookEndpointIn === undefined) {
                throw new baseapi_1.RequiredError("WebhookEndpointApi", "v1OperationalWebhookEndpointCreate", "operationalWebhookEndpointIn");
            }
    ...
    v1OperationalWebhookEndpointDelete(endpointId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (endpointId === null || endpointId === undefined) {
                throw new baseapi_1.RequiredError("WebhookEndpointApi", "v1OperationalWebhookEndpointDelete", "endpointId");
            }
    ...
    v1OperationalWebhookEndpointGet(endpointId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (endpointId === null || endpointId === undefined) {
                throw new baseapi_1.RequiredError("WebhookEndpointApi", "v1OperationalWebhookEndpointGet", "endpointId");
            }
            const localVarPath = '/api/v1/operational-webhook/endpoint/{endpoint_id}'
                .replace('{' + 'endpoint_id' + '}', encodeURIComponent(String(endpointId)));
    ...
    v1OperationalWebhookEndpointGetHeaders(endpointId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (endpointId === null || endpointId === undefined) {
                throw new baseapi_1.RequiredError("WebhookEndpointApi", "v1OperationalWebhookEndpointGetHeaders", "endpointId");
            }
    ...
    v1OperationalWebhookEndpointGetSecret(endpointId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (endpointId === null || endpointId === undefined) {
                throw new baseapi_1.RequiredError("WebhookEndpointApi", "v1OperationalWebhookEndpointGetSecret", "endpointId");
            }
    ...
    v1OperationalWebhookEndpointRotateSecret(endpointId, operationalWebhookEndpointSecretIn, idempotencyKey, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (endpointId === null || endpointId === undefined) {
                throw new baseapi_1.RequiredError("WebhookEndpointApi", "v1OperationalWebhookEndpointRotateSecret", "endpointId");
            }
            if (operationalWebhookEndpointSecretIn === null || operationalWebhookEndpointSecretIn === undefined) {
                throw new baseapi_1.RequiredError("WebhookEndpointApi", "v1OperationalWebhookEndpointRotateSecret", "operationalWebhookEndpointSecretIn");
            }
    ...
    v1OperationalWebhookEndpointUpdate(endpointId, operationalWebhookEndpointUpdate, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (endpointId === null || endpointId === undefined) {
                throw new baseapi_1.RequiredError("WebhookEndpointApi", "v1OperationalWebhookEndpointUpdate", "endpointId");
            }
            if (operationalWebhookEndpointUpdate === null || operationalWebhookEndpointUpdate === undefined) {
                throw new baseapi_1.RequiredError("WebhookEndpointApi", "v1OperationalWebhookEndpointUpdate", "operationalWebhookEndpointUpdate");
            }
            const localVarPath = '/api/v1/operational-webhook/endpoint/{endpoint_id}'
                .replace('{' + 'endpoint_id' + '}', encodeURIComponent(String(endpointId)));
    ...
    v1OperationalWebhookEndpointUpdateHeaders(endpointId, operationalWebhookEndpointHeadersIn, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (endpointId === null || endpointId === undefined) {
                throw new baseapi_1.RequiredError("WebhookEndpointApi", "v1OperationalWebhookEndpointUpdateHeaders", "endpointId");
            }
            if (operationalWebhookEndpointHeadersIn === null || operationalWebhookEndpointHeadersIn === undefined) {
                throw new baseapi_1.RequiredError("WebhookEndpointApi", "v1OperationalWebhookEndpointUpdateHeaders", "operationalWebhookEndpointHeadersIn");
            }
            const localVarPath = '/api/v1/operational-webhook/endpoint/{endpoint_id}/headers'
                .replace('{' + 'endpoint_id' + '}', encodeURIComponent(String(endpointId)));
            const requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.PUT);
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(operationalWebhookEndpointHeadersIn, "OperationalWebhookEndpointHeadersIn", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["HTTPBearer"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
...
class WebhookEndpointApiResponseProcessor {
    v1OperationalWebhookEndpointCreateWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    v1OperationalWebhookEndpointDeleteWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    ...
    v1OperationalWebhookEndpointGetWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    ...
    v1OperationalWebhookEndpointGetHeadersWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "OperationalWebhookEndpointHeadersOut", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("400", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "HttpErrorOut", "");
    ...
    v1OperationalWebhookEndpointGetSecretWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
    ...
    v1OperationalWebhookEndpointListWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
    ...
    v1OperationalWebhookEndpointRotateSecretWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("204", response.httpStatusCode)) {
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
    ...
    v1OperationalWebhookEndpointUpdateWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "OperationalWebhookEndpointOut", "");
    ...
    v1OperationalWebhookEndpointUpdateHeadersWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("204", response.httpStatusCode)) {
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
