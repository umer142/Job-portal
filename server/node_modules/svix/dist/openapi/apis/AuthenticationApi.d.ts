...
export declare class AuthenticationApiRequestFactory extends BaseAPIRequestFactory {
    ...
    v1AuthenticationStreamPortalAccess(streamId: string, streamPortalAccessIn: StreamPortalAccessIn, idempotencyKey?: string, _options?: Configuration): Promise<RequestContext>;
}
export declare class AuthenticationApiResponseProcessor {
    ...
    v1AuthenticationStreamPortalAccessWithHttpInfo(response: ResponseContext): Promise<HttpInfo<AppPortalAccessOut>>;
}
