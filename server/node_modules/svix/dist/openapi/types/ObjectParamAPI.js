...
class ObjectAuthenticationApi {
    ...
    v1AuthenticationStreamPortalAccessWithHttpInfo(param, options) {
    ...
    v1AuthenticationStreamPortalAccess(param, options) {
...
class ObjectBackgroundTasksApi {
    ...
    v1BackgroundTaskList(param = {}, options) {
...
class ObjectStreamApi {
    ...
    v1StreamEventsCreateWithHttpInfo(param, options) {
    ...
    v1StreamEventsCreate(param, options) {
...
class ObjectWebhookEndpointApi {
    ...
    v1OperationalWebhookEndpointCreateWithHttpInfo(param, options) {
    ...
    v1OperationalWebhookEndpointCreate(param, options) {
    ...
    v1OperationalWebhookEndpointRotateSecret(param, options) {
    ...
    v1OperationalWebhookEndpointUpdateWithHttpInfo(param, options) {
    ...
    v1OperationalWebhookEndpointUpdate(param, options) {
    ...
    v1OperationalWebhookEndpointUpdateHeadersWithHttpInfo(param, options) {
    ...
    v1OperationalWebhookEndpointUpdateHeaders(param, options) {
