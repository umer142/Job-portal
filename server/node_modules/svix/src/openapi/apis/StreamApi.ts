...
export class StreamApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async v1StreamEventsCreate(streamId: string, createStreamIn: CreateStreamIn, idempotencyKey?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'streamId' is not null or undefined
        if (streamId === null || streamId === undefined) {
            throw new RequiredError("StreamApi", "v1StreamEventsCreate", "streamId");
        }


        // verify required parameter 'createStreamIn' is not null or undefined
        if (createStreamIn === null || createStreamIn === undefined) {
            throw new RequiredError("StreamApi", "v1StreamEventsCreate", "createStreamIn");
        }
     ...
     * @param idempotencyKey The request\&#39;s idempotency key
     */
    public async v1StreamStreamCreate(streamIn: StreamIn, idempotencyKey?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'streamIn' is not null or undefined
        if (streamIn === null || streamIn === undefined) {
            throw new RequiredError("StreamApi", "v1StreamStreamCreate", "streamIn");
        }
     ...
     * @param streamId The Stream\&#39;s ID or UID.
     */
    public async v1StreamStreamDelete(streamId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'streamId' is not null or undefined
        if (streamId === null || streamId === undefined) {
            throw new RequiredError("StreamApi", "v1StreamStreamDelete", "streamId");
        }
     ...
     * @param streamId The Stream\&#39;s ID or UID.
     */
    public async v1StreamStreamGet(streamId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'streamId' is not null or undefined
        if (streamId === null || streamId === undefined) {
            throw new RequiredError("StreamApi", "v1StreamStreamGet", "streamId");
        }
     ...
     */
    public async v1StreamStreamList(limit?: number, iterator?: string, order?: Ordering, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param streamPatch 
     */
    public async v1StreamStreamPatch(streamId: string, streamPatch: StreamPatch, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'streamId' is not null or undefined
        if (streamId === null || streamId === undefined) {
            throw new RequiredError("StreamApi", "v1StreamStreamPatch", "streamId");
        }


        // verify required parameter 'streamPatch' is not null or undefined
        if (streamPatch === null || streamPatch === undefined) {
            throw new RequiredError("StreamApi", "v1StreamStreamPatch", "streamPatch");
        }
     ...
     * @param streamIn 
     */
    public async v1StreamStreamUpdate(streamId: string, streamIn: StreamIn, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'streamId' is not null or undefined
        if (streamId === null || streamId === undefined) {
            throw new RequiredError("StreamApi", "v1StreamStreamUpdate", "streamId");
        }


        // verify required parameter 'streamIn' is not null or undefined
        if (streamIn === null || streamIn === undefined) {
            throw new RequiredError("StreamApi", "v1StreamStreamUpdate", "streamIn");
        }
...
export class StreamApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to v1StreamEventsCreate
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1StreamEventsCreateWithHttpInfo(response: ResponseContext): Promise<HttpInfo<any >> {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to v1StreamStreamCreate
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1StreamStreamCreateWithHttpInfo(response: ResponseContext): Promise<HttpInfo<StreamOut >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to v1StreamStreamDelete
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1StreamStreamDeleteWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to v1StreamStreamGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1StreamStreamGetWithHttpInfo(response: ResponseContext): Promise<HttpInfo<StreamOut >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: StreamOut = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to v1StreamStreamList
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1StreamStreamListWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ListResponseStreamOut >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to v1StreamStreamPatch
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1StreamStreamPatchWithHttpInfo(response: ResponseContext): Promise<HttpInfo<StreamOut >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: StreamOut = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to v1StreamStreamUpdate
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1StreamStreamUpdateWithHttpInfo(response: ResponseContext): Promise<HttpInfo<StreamOut >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: StreamOut = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
