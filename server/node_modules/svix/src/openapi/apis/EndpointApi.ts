...
export class EndpointApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param endpointId The Endpoint\&#39;s ID or UID.
     */
    public async v1EndpointGetMtlsConfig(appId: string, endpointId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'appId' is not null or undefined
        if (appId === null || appId === undefined) {
            throw new RequiredError("EndpointApi", "v1EndpointGetMtlsConfig", "appId");
        }


        // verify required parameter 'endpointId' is not null or undefined
        if (endpointId === null || endpointId === undefined) {
            throw new RequiredError("EndpointApi", "v1EndpointGetMtlsConfig", "endpointId");
        }
     ...
     * @param endpointId The Endpoint\&#39;s ID or UID.
     */
    public async v1EndpointGetOauthConfig(appId: string, endpointId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'appId' is not null or undefined
        if (appId === null || appId === undefined) {
            throw new RequiredError("EndpointApi", "v1EndpointGetOauthConfig", "appId");
        }


        // verify required parameter 'endpointId' is not null or undefined
        if (endpointId === null || endpointId === undefined) {
            throw new RequiredError("EndpointApi", "v1EndpointGetOauthConfig", "endpointId");
        }
...
export class EndpointApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to v1EndpointGetMtlsConfig
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1EndpointGetMtlsConfigWithHttpInfo(response: ResponseContext): Promise<HttpInfo<EndpointMtlsConfigOut >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: EndpointMtlsConfigOut = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "EndpointMtlsConfigOut", ""
            ) as EndpointMtlsConfigOut;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: HttpErrorOut = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to v1EndpointGetOauthConfig
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1EndpointGetOauthConfigWithHttpInfo(response: ResponseContext): Promise<HttpInfo<EndpointOauthConfigOut >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: EndpointOauthConfigOut = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "EndpointOauthConfigOut", ""
            ) as EndpointOauthConfigOut;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: HttpErrorOut = ObjectSerializer.deserialize(
