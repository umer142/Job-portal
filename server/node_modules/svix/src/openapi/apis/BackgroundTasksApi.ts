...
export class BackgroundTasksApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async v1BackgroundTaskGet(taskId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'taskId' is not null or undefined
        if (taskId === null || taskId === undefined) {
            throw new RequiredError("BackgroundTasksApi", "v1BackgroundTaskGet", "taskId");
        }
     ...
     */
    public async v1BackgroundTaskList(status?: BackgroundTaskStatus, task?: BackgroundTaskType, limit?: number, iterator?: string, order?: Ordering, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class BackgroundTasksApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to v1BackgroundTaskGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1BackgroundTaskGetWithHttpInfo(response: ResponseContext): Promise<HttpInfo<BackgroundTaskOut >> {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to v1BackgroundTaskList
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1BackgroundTaskListWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ListResponseBackgroundTaskOut >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
