...
import { ActiveApplicationOut } from '../models/ActiveApplicationOut';
import { ActiveEndpointOut } from '../models/ActiveEndpointOut';
import { AggregateEventTypesOut } from '../models/AggregateEventTypesOut';
import { AggregatedEventTypes } from '../models/AggregatedEventTypes';
...
import { ApplicationMessageFailure } from '../models/ApplicationMessageFailure';
import { ApplicationMessageIdPair } from '../models/ApplicationMessageIdPair';
...
import { ApplicationStatsOut } from '../models/ApplicationStatsOut';
...
import { BackgroundTaskFinishedEvent } from '../models/BackgroundTaskFinishedEvent';
import { BackgroundTaskFinishedEvent2 } from '../models/BackgroundTaskFinishedEvent2';
...
import { ConnectorKind } from '../models/ConnectorKind';
...
import { DataAnyOf } from '../models/DataAnyOf';
import { DataAnyOf1 } from '../models/DataAnyOf1';
import { DataAnyOf2 } from '../models/DataAnyOf2';
import { DataAnyOf3 } from '../models/DataAnyOf3';
import { DataAnyOf4 } from '../models/DataAnyOf4';
...
import { EndpointDisabledTrigger } from '../models/EndpointDisabledTrigger';
import { EndpointEnabledEvent } from '../models/EndpointEnabledEvent';
import { EndpointEnabledEventData } from '../models/EndpointEnabledEventData';
...
import { ExpungAllContentsOut } from '../models/ExpungAllContentsOut';
...
import { ListResponseActiveApplicationOut } from '../models/ListResponseActiveApplicationOut';
...
import { Oauth2AuthMethodInOut } from '../models/Oauth2AuthMethodInOut';
import { Oauth2GrantTypeInOut } from '../models/Oauth2GrantTypeInOut';
...
import { PollingEndpointMessageOut } from '../models/PollingEndpointMessageOut';
...
import { SinkSecretOut } from '../models/SinkSecretOut';
...
export class ObservableApplicationApi {
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1MessageExpungeAllContentsWithHttpInfo(appId: string, idempotencyKey?: string, _options?: Configuration): Observable<HttpInfo<ExpungAllContentsOut>> {
        const requestContextPromise = this.requestFactory.v1MessageExpungeAllContents(appId, idempotencyKey, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1MessageExpungeAllContentsWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1MessageExpungeAllContents(appId: string, idempotencyKey?: string, _options?: Configuration): Observable<ExpungAllContentsOut> {
        return this.v1MessageExpungeAllContentsWithHttpInfo(appId, idempotencyKey, _options).pipe(map((apiResponse: HttpInfo<ExpungAllContentsOut>) => apiResponse.data));
    }
...
export class ObservableAuthenticationApi {
     ...
     * @param streamPortalAccessIn
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1AuthenticationStreamPortalAccessWithHttpInfo(streamId: string, streamPortalAccessIn: StreamPortalAccessIn, idempotencyKey?: string, _options?: Configuration): Observable<HttpInfo<AppPortalAccessOut>> {
        const requestContextPromise = this.requestFactory.v1AuthenticationStreamPortalAccess(streamId, streamPortalAccessIn, idempotencyKey, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1AuthenticationStreamPortalAccessWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1AuthenticationStreamPortalAccess(streamId: string, streamPortalAccessIn: StreamPortalAccessIn, idempotencyKey?: string, _options?: Configuration): Observable<AppPortalAccessOut> {
        return this.v1AuthenticationStreamPortalAccessWithHttpInfo(streamId, streamPortalAccessIn, idempotencyKey, _options).pipe(map((apiResponse: HttpInfo<AppPortalAccessOut>) => apiResponse.data));
    }
...
export class ObservableBackgroundTasksApi {
     ...
     */
    public v1BackgroundTaskGetWithHttpInfo(taskId: string, _options?: Configuration): Observable<HttpInfo<BackgroundTaskOut>> {
        const requestContextPromise = this.requestFactory.v1BackgroundTaskGet(taskId, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1BackgroundTaskGetWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param taskId The QueueBackgroundTask\&#39;s ID.
     */
    public v1BackgroundTaskGet(taskId: string, _options?: Configuration): Observable<BackgroundTaskOut> {
        return this.v1BackgroundTaskGetWithHttpInfo(taskId, _options).pipe(map((apiResponse: HttpInfo<BackgroundTaskOut>) => apiResponse.data));
    }
     ...
     * @param [order] The sorting order of the returned items
     */
    public v1BackgroundTaskListWithHttpInfo(status?: BackgroundTaskStatus, task?: BackgroundTaskType, limit?: number, iterator?: string, order?: Ordering, _options?: Configuration): Observable<HttpInfo<ListResponseBackgroundTaskOut>> {
        const requestContextPromise = this.requestFactory.v1BackgroundTaskList(status, task, limit, iterator, order, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1BackgroundTaskListWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param [order] The sorting order of the returned items
     */
    public v1BackgroundTaskList(status?: BackgroundTaskStatus, task?: BackgroundTaskType, limit?: number, iterator?: string, order?: Ordering, _options?: Configuration): Observable<ListResponseBackgroundTaskOut> {
        return this.v1BackgroundTaskListWithHttpInfo(status, task, limit, iterator, order, _options).pipe(map((apiResponse: HttpInfo<ListResponseBackgroundTaskOut>) => apiResponse.data));
    }
...
export class ObservableEndpointApi {
     ...
     * @param endpointId The Endpoint\&#39;s ID or UID.
     */
    public v1EndpointGetMtlsConfigWithHttpInfo(appId: string, endpointId: string, _options?: Configuration): Observable<HttpInfo<EndpointMtlsConfigOut>> {
        const requestContextPromise = this.requestFactory.v1EndpointGetMtlsConfig(appId, endpointId, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1EndpointGetMtlsConfigWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param endpointId The Endpoint\&#39;s ID or UID.
     */
    public v1EndpointGetMtlsConfig(appId: string, endpointId: string, _options?: Configuration): Observable<EndpointMtlsConfigOut> {
        return this.v1EndpointGetMtlsConfigWithHttpInfo(appId, endpointId, _options).pipe(map((apiResponse: HttpInfo<EndpointMtlsConfigOut>) => apiResponse.data));
    }
     ...
     * @param endpointId The Endpoint\&#39;s ID or UID.
     */
    public v1EndpointGetOauthConfigWithHttpInfo(appId: string, endpointId: string, _options?: Configuration): Observable<HttpInfo<EndpointOauthConfigOut>> {
        const requestContextPromise = this.requestFactory.v1EndpointGetOauthConfig(appId, endpointId, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1EndpointGetOauthConfigWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param endpointId The Endpoint\&#39;s ID or UID.
     */
    public v1EndpointGetOauthConfig(appId: string, endpointId: string, _options?: Configuration): Observable<EndpointOauthConfigOut> {
        return this.v1EndpointGetOauthConfigWithHttpInfo(appId, endpointId, _options).pipe(map((apiResponse: HttpInfo<EndpointOauthConfigOut>) => apiResponse.data));
    }
...
export class ObservableMessageApi {
     ...
     * @param [after]
     */
    public v1EventsPublicWithHttpInfo(appId: string, sinkId: string, limit?: number, iterator?: string, eventType?: string, channel?: string, after?: Date, _options?: Configuration): Observable<HttpInfo<PollingEndpointOut>> {
     ...
     * @param [after]
     */
    public v1EventsPublic(appId: string, sinkId: string, limit?: number, iterator?: string, eventType?: string, channel?: string, after?: Date, _options?: Configuration): Observable<PollingEndpointOut> {
        return this.v1EventsPublicWithHttpInfo(appId, sinkId, limit, iterator, eventType, channel, after, _options).pipe(map((apiResponse: HttpInfo<PollingEndpointOut>) => apiResponse.data));
    }
     ...
     * @param appId The Application\&#39;s ID or UID.
     * @param messagePrecheckIn
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1MessagePrecheckWithHttpInfo(appId: string, messagePrecheckIn: MessagePrecheckIn, idempotencyKey?: string, _options?: Configuration): Observable<HttpInfo<MessagePrecheckOut>> {
        const requestContextPromise = this.requestFactory.v1MessagePrecheck(appId, messagePrecheckIn, idempotencyKey, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1MessagePrecheckWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1MessagePrecheck(appId: string, messagePrecheckIn: MessagePrecheckIn, idempotencyKey?: string, _options?: Configuration): Observable<MessagePrecheckOut> {
        return this.v1MessagePrecheckWithHttpInfo(appId, messagePrecheckIn, idempotencyKey, _options).pipe(map((apiResponse: HttpInfo<MessagePrecheckOut>) => apiResponse.data));
    }
...
export class ObservableStreamApi {
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1StreamEventsCreateWithHttpInfo(streamId: string, createStreamIn: CreateStreamIn, idempotencyKey?: string, _options?: Configuration): Observable<HttpInfo<any>> {
        const requestContextPromise = this.requestFactory.v1StreamEventsCreate(streamId, createStreamIn, idempotencyKey, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1StreamEventsCreateWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1StreamEventsCreate(streamId: string, createStreamIn: CreateStreamIn, idempotencyKey?: string, _options?: Configuration): Observable<any> {
        return this.v1StreamEventsCreateWithHttpInfo(streamId, createStreamIn, idempotencyKey, _options).pipe(map((apiResponse: HttpInfo<any>) => apiResponse.data));
    }
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1StreamStreamCreateWithHttpInfo(streamIn: StreamIn, idempotencyKey?: string, _options?: Configuration): Observable<HttpInfo<StreamOut>> {
        const requestContextPromise = this.requestFactory.v1StreamStreamCreate(streamIn, idempotencyKey, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1StreamStreamCreateWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1StreamStreamCreate(streamIn: StreamIn, idempotencyKey?: string, _options?: Configuration): Observable<StreamOut> {
        return this.v1StreamStreamCreateWithHttpInfo(streamIn, idempotencyKey, _options).pipe(map((apiResponse: HttpInfo<StreamOut>) => apiResponse.data));
    }
     ...
     * @param streamId The Stream\&#39;s ID or UID.
     */
    public v1StreamStreamDeleteWithHttpInfo(streamId: string, _options?: Configuration): Observable<HttpInfo<void>> {
        const requestContextPromise = this.requestFactory.v1StreamStreamDelete(streamId, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1StreamStreamDeleteWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param streamId The Stream\&#39;s ID or UID.
     */
    public v1StreamStreamDelete(streamId: string, _options?: Configuration): Observable<void> {
        return this.v1StreamStreamDeleteWithHttpInfo(streamId, _options).pipe(map((apiResponse: HttpInfo<void>) => apiResponse.data));
    }
     ...
     * @param streamId The Stream\&#39;s ID or UID.
     */
    public v1StreamStreamGetWithHttpInfo(streamId: string, _options?: Configuration): Observable<HttpInfo<StreamOut>> {
        const requestContextPromise = this.requestFactory.v1StreamStreamGet(streamId, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1StreamStreamGetWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param streamId The Stream\&#39;s ID or UID.
     */
    public v1StreamStreamGet(streamId: string, _options?: Configuration): Observable<StreamOut> {
        return this.v1StreamStreamGetWithHttpInfo(streamId, _options).pipe(map((apiResponse: HttpInfo<StreamOut>) => apiResponse.data));
    }
     ...
     * @param [order] The sorting order of the returned items
     */
    public v1StreamStreamListWithHttpInfo(limit?: number, iterator?: string, order?: Ordering, _options?: Configuration): Observable<HttpInfo<ListResponseStreamOut>> {
        const requestContextPromise = this.requestFactory.v1StreamStreamList(limit, iterator, order, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1StreamStreamListWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param [order] The sorting order of the returned items
     */
    public v1StreamStreamList(limit?: number, iterator?: string, order?: Ordering, _options?: Configuration): Observable<ListResponseStreamOut> {
        return this.v1StreamStreamListWithHttpInfo(limit, iterator, order, _options).pipe(map((apiResponse: HttpInfo<ListResponseStreamOut>) => apiResponse.data));
    }
     ...
     * @param streamPatch
     */
    public v1StreamStreamPatchWithHttpInfo(streamId: string, streamPatch: StreamPatch, _options?: Configuration): Observable<HttpInfo<StreamOut>> {
        const requestContextPromise = this.requestFactory.v1StreamStreamPatch(streamId, streamPatch, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1StreamStreamPatchWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param streamPatch
     */
    public v1StreamStreamPatch(streamId: string, streamPatch: StreamPatch, _options?: Configuration): Observable<StreamOut> {
        return this.v1StreamStreamPatchWithHttpInfo(streamId, streamPatch, _options).pipe(map((apiResponse: HttpInfo<StreamOut>) => apiResponse.data));
    }
     ...
     * @param streamIn
     */
    public v1StreamStreamUpdateWithHttpInfo(streamId: string, streamIn: StreamIn, _options?: Configuration): Observable<HttpInfo<StreamOut>> {
        const requestContextPromise = this.requestFactory.v1StreamStreamUpdate(streamId, streamIn, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1StreamStreamUpdateWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param streamIn
     */
    public v1StreamStreamUpdate(streamId: string, streamIn: StreamIn, _options?: Configuration): Observable<StreamOut> {
        return this.v1StreamStreamUpdateWithHttpInfo(streamId, streamIn, _options).pipe(map((apiResponse: HttpInfo<StreamOut>) => apiResponse.data));
    }
...
export class ObservableTransformationTemplateApi {
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1TransformationTemplateCreateWithHttpInfo(connectorIn: ConnectorIn, idempotencyKey?: string, _options?: Configuration): Observable<HttpInfo<TemplateOut>> {
        const requestContextPromise = this.requestFactory.v1TransformationTemplateCreate(connectorIn, idempotencyKey, _options);
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1TransformationTemplateCreate(connectorIn: ConnectorIn, idempotencyKey?: string, _options?: Configuration): Observable<TemplateOut> {
        return this.v1TransformationTemplateCreateWithHttpInfo(connectorIn, idempotencyKey, _options).pipe(map((apiResponse: HttpInfo<TemplateOut>) => apiResponse.data));
    }
...
export class ObservableWebhookEndpointApi {
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1OperationalWebhookEndpointCreateWithHttpInfo(operationalWebhookEndpointIn: OperationalWebhookEndpointIn, idempotencyKey?: string, _options?: Configuration): Observable<HttpInfo<OperationalWebhookEndpointOut>> {
        const requestContextPromise = this.requestFactory.v1OperationalWebhookEndpointCreate(operationalWebhookEndpointIn, idempotencyKey, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1OperationalWebhookEndpointCreateWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1OperationalWebhookEndpointCreate(operationalWebhookEndpointIn: OperationalWebhookEndpointIn, idempotencyKey?: string, _options?: Configuration): Observable<OperationalWebhookEndpointOut> {
        return this.v1OperationalWebhookEndpointCreateWithHttpInfo(operationalWebhookEndpointIn, idempotencyKey, _options).pipe(map((apiResponse: HttpInfo<OperationalWebhookEndpointOut>) => apiResponse.data));
    }
     ...
     * @param endpointId The Endpoint\&#39;s ID or UID.
     */
    public v1OperationalWebhookEndpointDeleteWithHttpInfo(endpointId: string, _options?: Configuration): Observable<HttpInfo<void>> {
        const requestContextPromise = this.requestFactory.v1OperationalWebhookEndpointDelete(endpointId, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1OperationalWebhookEndpointDeleteWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param endpointId The Endpoint\&#39;s ID or UID.
     */
    public v1OperationalWebhookEndpointDelete(endpointId: string, _options?: Configuration): Observable<void> {
        return this.v1OperationalWebhookEndpointDeleteWithHttpInfo(endpointId, _options).pipe(map((apiResponse: HttpInfo<void>) => apiResponse.data));
    }
     ...
     * @param endpointId The Endpoint\&#39;s ID or UID.
     */
    public v1OperationalWebhookEndpointGetWithHttpInfo(endpointId: string, _options?: Configuration): Observable<HttpInfo<OperationalWebhookEndpointOut>> {
        const requestContextPromise = this.requestFactory.v1OperationalWebhookEndpointGet(endpointId, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1OperationalWebhookEndpointGetWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param endpointId The Endpoint\&#39;s ID or UID.
     */
    public v1OperationalWebhookEndpointGet(endpointId: string, _options?: Configuration): Observable<OperationalWebhookEndpointOut> {
        return this.v1OperationalWebhookEndpointGetWithHttpInfo(endpointId, _options).pipe(map((apiResponse: HttpInfo<OperationalWebhookEndpointOut>) => apiResponse.data));
    }
     ...
     * @param endpointId The Endpoint\&#39;s ID or UID.
     */
    public v1OperationalWebhookEndpointGetHeadersWithHttpInfo(endpointId: string, _options?: Configuration): Observable<HttpInfo<OperationalWebhookEndpointHeadersOut>> {
        const requestContextPromise = this.requestFactory.v1OperationalWebhookEndpointGetHeaders(endpointId, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1OperationalWebhookEndpointGetHeadersWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param endpointId The Endpoint\&#39;s ID or UID.
     */
    public v1OperationalWebhookEndpointGetHeaders(endpointId: string, _options?: Configuration): Observable<OperationalWebhookEndpointHeadersOut> {
        return this.v1OperationalWebhookEndpointGetHeadersWithHttpInfo(endpointId, _options).pipe(map((apiResponse: HttpInfo<OperationalWebhookEndpointHeadersOut>) => apiResponse.data));
    }
     ...
     * @param endpointId The Endpoint\&#39;s ID or UID.
     */
    public v1OperationalWebhookEndpointGetSecretWithHttpInfo(endpointId: string, _options?: Configuration): Observable<HttpInfo<OperationalWebhookEndpointSecretOut>> {
        const requestContextPromise = this.requestFactory.v1OperationalWebhookEndpointGetSecret(endpointId, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1OperationalWebhookEndpointGetSecretWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param endpointId The Endpoint\&#39;s ID or UID.
     */
    public v1OperationalWebhookEndpointGetSecret(endpointId: string, _options?: Configuration): Observable<OperationalWebhookEndpointSecretOut> {
        return this.v1OperationalWebhookEndpointGetSecretWithHttpInfo(endpointId, _options).pipe(map((apiResponse: HttpInfo<OperationalWebhookEndpointSecretOut>) => apiResponse.data));
    }
     ...
     * @param [order] The sorting order of the returned items
     */
    public v1OperationalWebhookEndpointListWithHttpInfo(limit?: number, iterator?: string, order?: Ordering, _options?: Configuration): Observable<HttpInfo<ListResponseOperationalWebhookEndpointOut>> {
        const requestContextPromise = this.requestFactory.v1OperationalWebhookEndpointList(limit, iterator, order, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1OperationalWebhookEndpointListWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param [order] The sorting order of the returned items
     */
    public v1OperationalWebhookEndpointList(limit?: number, iterator?: string, order?: Ordering, _options?: Configuration): Observable<ListResponseOperationalWebhookEndpointOut> {
        return this.v1OperationalWebhookEndpointListWithHttpInfo(limit, iterator, order, _options).pipe(map((apiResponse: HttpInfo<ListResponseOperationalWebhookEndpointOut>) => apiResponse.data));
    }
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1OperationalWebhookEndpointRotateSecretWithHttpInfo(endpointId: string, operationalWebhookEndpointSecretIn: OperationalWebhookEndpointSecretIn, idempotencyKey?: string, _options?: Configuration): Observable<HttpInfo<void>> {
        const requestContextPromise = this.requestFactory.v1OperationalWebhookEndpointRotateSecret(endpointId, operationalWebhookEndpointSecretIn, idempotencyKey, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1OperationalWebhookEndpointRotateSecretWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1OperationalWebhookEndpointRotateSecret(endpointId: string, operationalWebhookEndpointSecretIn: OperationalWebhookEndpointSecretIn, idempotencyKey?: string, _options?: Configuration): Observable<void> {
        return this.v1OperationalWebhookEndpointRotateSecretWithHttpInfo(endpointId, operationalWebhookEndpointSecretIn, idempotencyKey, _options).pipe(map((apiResponse: HttpInfo<void>) => apiResponse.data));
    }
     ...
     */
    public v1OperationalWebhookEndpointUpdateWithHttpInfo(endpointId: string, operationalWebhookEndpointUpdate: OperationalWebhookEndpointUpdate, _options?: Configuration): Observable<HttpInfo<OperationalWebhookEndpointOut>> {
        const requestContextPromise = this.requestFactory.v1OperationalWebhookEndpointUpdate(endpointId, operationalWebhookEndpointUpdate, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1OperationalWebhookEndpointUpdateWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param operationalWebhookEndpointUpdate
     */
    public v1OperationalWebhookEndpointUpdate(endpointId: string, operationalWebhookEndpointUpdate: OperationalWebhookEndpointUpdate, _options?: Configuration): Observable<OperationalWebhookEndpointOut> {
        return this.v1OperationalWebhookEndpointUpdateWithHttpInfo(endpointId, operationalWebhookEndpointUpdate, _options).pipe(map((apiResponse: HttpInfo<OperationalWebhookEndpointOut>) => apiResponse.data));
    }
     ...
     * @param endpointId The Endpoint\&#39;s ID or UID.
     * @param operationalWebhookEndpointHeadersIn
     */
    public v1OperationalWebhookEndpointUpdateHeadersWithHttpInfo(endpointId: string, operationalWebhookEndpointHeadersIn: OperationalWebhookEndpointHeadersIn, _options?: Configuration): Observable<HttpInfo<void>> {
        const requestContextPromise = this.requestFactory.v1OperationalWebhookEndpointUpdateHeaders(endpointId, operationalWebhookEndpointHeadersIn, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1OperationalWebhookEndpointUpdateHeadersWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param operationalWebhookEndpointHeadersIn
     */
    public v1OperationalWebhookEndpointUpdateHeaders(endpointId: string, operationalWebhookEndpointHeadersIn: OperationalWebhookEndpointHeadersIn, _options?: Configuration): Observable<void> {
        return this.v1OperationalWebhookEndpointUpdateHeadersWithHttpInfo(endpointId, operationalWebhookEndpointHeadersIn, _options).pipe(map((apiResponse: HttpInfo<void>) => apiResponse.data));
    }
