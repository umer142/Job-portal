...
const JobCard = ({job }) => {
  ...
  return (
    <div className=" hover:bg-green-300  hover:border-blue-300 border p-5 shadow rounded">
    <div className="flex  justify-between items-center">
      <img className="h-8 scale-150" src={job.companyId.image} alt="" />
    ...
    <div className="mt-4 flex gap-2 text-xs ">
        ...
        <button onClick={() => {navigate(`/apply-job/${job._id}`); scrollTo(0,0)}} className="text-gray-500 border border-gray-500 rounded px-6 py-2">Learn more</button>
    </div>
  </div>
  )
}
