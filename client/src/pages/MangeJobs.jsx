        ...
        <table className="min-w-full bg-white border border-gray-200 max-sm:text-sm " >
          <thead>
            <tr>
              ...
              <th className="py-2 px-4 border-b border-gray-200 text-left max-sm:hidden  ">Loacation</th>
              <th className="py-2 px-4 border-b border-gray-200  text-center">Applications</th>
